...
<body>
    ...
    <form action="../api/routes.php?request=create_announcement" method="post" enctype="multipart/form-data">
        <!-- user id  -->
    ...
    <?php foreach ($announcements as $content) : ?>
        <div>
            ...
            <a href="javascript:void(0)" onclick="editAnnouncement(<?php echo $content['id']; ?>)">Edit</a>
            <!-- archive -->
